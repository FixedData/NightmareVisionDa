...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			case 'senpai':
				hasDialog = true;
				box.frames = Paths.getSparrowAtlas('week6/pixelUI/dialogueBox-pixel');
			...
			case 'roses':
				...
				box.frames = Paths.getSparrowAtlas('week6/pixelUI/dialogueBox-senpaiMad');
				box.animation.addByPrefix('normalOpen', 'SENPAI ANGRY IMPACT SPEECH', 24, false);
				box.animation.addByIndices('normal', 'SENPAI ANGRY IMPACT SPEECH instance 1', [4], "", 24);
				
			case 'thorns':
				hasDialog = true;
				box.frames = Paths.getSparrowAtlas('week6/pixelUI/dialogueBox-evil');
				box.animation.addByPrefix('normalOpen', 'Spirit Textbox spawn', 24, false);
				box.animation.addByIndices('normal', 'Spirit Textbox spawn instance 1', [11], "", 24);
				
				var face:FlxSprite = new FlxSprite(320, 170).loadGraphic(Paths.image('week6/spiritFaceForward'));
		...
		portraitLeft.frames = Paths.getSparrowAtlas('week6/senpaiPortrait');
		...
		portraitRight.frames = Paths.getSparrowAtlas('week6/bfPortrait');
		...
		handSelect = new FlxSprite(1042, 590).loadGraphic(Paths.image('week6/pixelUI/hand_textbox'));
