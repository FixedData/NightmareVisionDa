...
class Character extends FlxSprite
{
	...
	{
		var characterPath:String = Paths.getSharedPath('characters/' + character + '.json');
		
		if (!Assets.exists(characterPath))
		{
			characterPath = Paths.getSharedPath('characters/' + DEFAULT_CHARACTER + '.json');
		}
		
		return Json.parse(Assets.getText(characterPath));
	}
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		// move this out of new and make it a function
	...
	inline public function returnDisplacePoint():FlxPoint
	{
		...
		if (animation.curAnim == null) return displace;
