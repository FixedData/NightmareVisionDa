...
@:build(funkin.scripting.ScriptMacro.buildPlaystate())
class Stage extends FlxTypedContainer<FlxBasic>
{
	public function addBehindGF(obj:FlxBasic)
	{
		insert(members.indexOf(gameState.gfGroup), obj);
	}
	
	public function addBehindBF(obj:FlxBasic)
	{
		insert(members.indexOf(gameState.boyfriendGroup), obj);
	}
	
	public function addBehindDad(obj:FlxBasic)
	{
		insert(members.indexOf(gameState.dadGroup), obj);
	}
